...
| **클라우드 배포**    | 한석규      | - EC2 인스턴스 생성 <br> - 보안 그룹 설정 (포트 개방 등) <br> - EC2 인스턴스에 SSH 연결 및 초기 설정 <br> - 애플리케이션 및 필요한 라이브러리 설치 <br> - 서버 환경 변수 설정 <br> - 애플리케이션 배포 (배포 자동화 스크립트 적용 등) <br> - 도메인 연결 및 SSL 설정 (필요시) |
